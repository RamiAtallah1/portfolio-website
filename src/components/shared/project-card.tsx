...
export default function ProjectCard({ project }: { project: Project }) {
  return (
    ...
    >
      <div className="max-w-[380px] rounded-3xl p-px bg-gradient-to-br from-blue-500/50 via-purple-500/30 to-pink-500/50 bg-[length:200%_200%] [background-position:0%_0%] transition-[background-position] duration-700 group-hover:[background-position:100%_100%]">
        <div className="text-white rounded-3xl bg-gradient-to-br from-gray-900 via-gray-800 to-black shadow-2xl duration-700 z-10 relative backdrop-blur-xl overflow-hidden hover:shadow-white/5 hover:shadow-3xl min-h-[380px] h-full flex flex-col justify-between">
          {/* Background Effects */}
          ...
          {/* Content */}
          <div className="p-8 relative z-10 flex flex-col flex-1 justify-between">
